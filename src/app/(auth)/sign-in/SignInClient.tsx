...
export default function SignInClient({ initialOauthError, initialOauthProvider }: SignInClientProps) {
    ...
    const initialShowCreateAccountCta =
                ...
                <form onSubmit={onSubmit} className="space-y-5">
                    {error && (
                        <div className="p-3 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm space-y-2">
                            <p>{error}</p>
                            {initialShowCreateAccountCta && (
                                <p className="font-semibold  text-red-700">Create account first.</p>
                            )}
                        </div>
                    )}
