        ...
        <div className="text-center pt-4">
          ...
          {/* {!isPhotographerSignup && (
            <p className="mt-2 text-xs text-slate-500">
              Are you a photographer? <Link href="/sign-up?role=photographer" className="font-semibold text-indigo-600 hover:text-indigo-700 hover:underline transition-colors">Sign up as photographer</Link>
            </p>
          )} */}
