...
import { updateProjectName } from "@/services/projects.service";
...
export default function RenameProjectModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSubmitting(true);
      await updateProjectName({ projectId, name: trimmed });
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display text-lg font-bold text-brand-900">Rename project</h3>
        </div>
